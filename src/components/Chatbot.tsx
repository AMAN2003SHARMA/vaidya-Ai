  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const chat = ai.chats.create({
        ...
        config: {
          systemInstruction: "You are 'Indian Medical', a helpful, culturally aware medical AI assistant. Provide general health advice, but always remind users to consult a real doctor. Use a mix of English and common Indian health terms where appropriate. Keep responses concise and structured.",
        }
      });
